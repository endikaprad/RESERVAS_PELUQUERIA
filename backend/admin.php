...
================================================================ -->
    ...
    `;
                ...
                const ultimos6 = Array.from({
                    length: 6
                }, (_, i) => meses[(mesActual - 5 + i + 12) % 12]);
        ...
        <div style= "padding:1.5rem 2rem;border-bottom:1px solid #252530;" >
                ...
                background: linear - gradient(90 deg, $ {
                    ...
                    99);
                transition: width 1.2 s cubic - bezier(.16, 1, .3, 1) .2 s;
                --target - w: $ {
                    pct
                } % ;
                "></div> < /
                ...
                border - radius: 6 px;
                color: #7a7880;font-family:'DM Sans',sans-serif;
...
function renderStats(d) {
    ...
    const html = ` <
                ...
                div >
                    ...
                    div class = "stats-section" >
                    <
                    div class = "stats-section-label" > Servicios & amp;
                conversión < /div> <
                div class = "stats-grid-2" >
                $ {
                ...
                style = "width:100%;" > Tasa de aceptación < /div>
                $ {
