...
<body style='margin:0;padding:0;background:#09080f;font-family:Arial,sans-serif;'>
  <div style='max-width:560px;margin:0 auto;background:#111119;border:1px solid #252530;border-radius:12px;overflow:hidden;'>
    <div style='background:#d42b2b;padding:24px 32px;'>
      ...
      <p style='margin:6px 0 0;color:rgba(255,255,255,0.8);font-size:14px;'>Prado Barber Co. - Necesita tu confirmacion</p>
    </div>
    <div style='padding:32px;'>
      <table style='width:100%;border-collapse:collapse;margin-bottom:28px;'>
        ...
        <tr><td style='padding:10px 0;border-bottom:1px solid #252530;color:#7a7880;font-size:13px;'>Hora</td>
            <td style='padding:10px 0;color:#d42b2b;font-size:16px;font-weight:700;'>{$hora}</td></tr>
        {$notasHtml}
      </table>
      ...
      <table style='width:100%;border-collapse:collapse;'>
        <tr>
          <td style='padding-right:8px;'>
            <a href='{$urlAceptar}' style='display:block;background:#22c55e;color:#fff;text-decoration:none;padding:14px;border-radius:6px;font-size:14px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;text-align:center;'>Aceptar reserva</a>
          </td>
          <td style='padding-left:8px;'>
            <a href='{$urlDenegar}' style='display:block;background:#d42b2b;color:#fff;text-decoration:none;padding:14px;border-radius:6px;font-size:14px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;text-align:center;'>Denegar reserva</a>
          </td>
        </tr>
      </table>
      <p style='color:#7a7880;font-size:12px;margin-top:24px;text-align:center;'>
        Reserva #{$id} - <a href='{$baseUrl}/backend/admin.php' style='color:#d42b2b;'>Panel de administracion</a>
      </p>
    </div>
  </div>
</body></html>";
...
<body style='margin:0;padding:0;background:#09080f;font-family:Arial,sans-serif;'>
  <div style='max-width:560px;margin:0 auto;background:#111119;border:1px solid #252530;border-radius:12px;overflow:hidden;'>
    <div style='background:#c9a84c;padding:24px 32px;'>
      ...
      <p style='margin:6px 0 0;color:rgba(0,0,0,0.6);font-size:14px;'>Prado Barber Co. - Bilbao</p>
    </div>
    <div style='padding:32px;'>
      ...
      <p style='color:#7a7880;font-size:13px;text-align:center;'>
        Necesitas cancelar? Llamanos al <a href='tel:+34944000000' style='color:#d42b2b;'>+34 944 000 000</a>
      </p>
    </div>
